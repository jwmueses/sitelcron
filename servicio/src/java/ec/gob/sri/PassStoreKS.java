...
public class PassStoreKS implements IPassStoreKS {
     ...
     * relacionado.</p>
     * 34 * @param pass Contraseña del almacén 35
     */
     ...
     * 42 * @param certificate No se utiliza 43 * @param alias no se utiliza 44
     * * @return contraseña configurada para este almacén 45 * @see
