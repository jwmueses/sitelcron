...
public class DocumentosElectronicosSri{
    ...
    public void execute() {
        ...
        System.out.println(Fecha.getFecha("SQL") + " " + Fecha.getHora() + ": Inicio de envio de documentos al SRI. " + rutaArchivoFirmado );
...
//            new Correo( Parametro.getSvrMail(), Parametro.getSvrMailPuerto(), "facturacion.sait2@gmail.com", Parametro.getRemitenteClave() ),
//            new Correo( Parametro.getSvrMail(), Parametro.getSvrMailPuerto(), "facturacion.sait3@gmail.com", Parametro.getRemitenteClave() ),
//            new Correo( Parametro.getSvrMail(), Parametro.getSvrMailPuerto(), "facturacion.sait4@gmail.com", Parametro.getRemitenteClave() ),
//            new Correo( Parametro.getSvrMail(), Parametro.getSvrMailPuerto(), "facturacion.sait5@gmail.com", Parametro.getRemitenteClave() ),
//            new Correo( Parametro.getSvrMail(), Parametro.getSvrMailPuerto(), "facturacion.sait6@gmail.com", Parametro.getRemitenteClave() ),
//            new Correo( Parametro.getSvrMail(), Parametro.getSvrMailPuerto(), "facturacion.sait7@gmail.com", Parametro.getRemitenteClave() ),
//            new Correo( Parametro.getSvrMail(), Parametro.getSvrMailPuerto(), "facturacion.sait8@gmail.com", Parametro.getRemitenteClave() ),
//            new Correo( Parametro.getSvrMail(), Parametro.getSvrMailPuerto(), "facturacion.sait9@gmail.com", Parametro.getRemitenteClave() ),
//            new Correo( Parametro.getSvrMail(), Parametro.getSvrMailPuerto(), "facturacion.sait10@gmail.com", Parametro.getRemitenteClave() ),
//            new Correo( Parametro.getSvrMail(), Parametro.getSvrMailPuerto(), "facturacion.sait11@gmail.com", Parametro.getRemitenteClave() )
//        };
//        
//        int i=0;
//        
...
//                        }
//
//                        while( correos[i].enviar(email, "", "", "SAITEL - FACTURA ELECTRONICA", mensaje, true, adjuntos) ){
//                            i++;
//                            if( i == correos.length ){
//                                i=0;
//                            }
...
//                            i=0;
//                        }
//                        while( correos[i].enviar(email, "", "", "SAITEL - RETENCION ELECTRONICA", mensaje, true, adjuntos) ){
//                            i++;
//                            if( i == correos.length ){
//                                i=0;
//                            }
...
//                            i=0;
//                        }
//                        while( correos[i].enviar(email, "", "", "SAITEL - NOTA DE CREDITO ELECTRONICA", mensaje, true, adjuntos) ){
//                            i++;
//                            if( i == correos.length ){
//                                i=0;
//                            }
...
//        }
            ...
            System.out.println(Fecha.getFecha("SQL") + " " + Fecha.getHora() + ": Finalización de envio de documentos al SRI");
            objDataBase.cerrar();
