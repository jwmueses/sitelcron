...
public class Parametro {
    ...
    private static final String doc_ip = "127.0.0.1";      //  127.0.0.1     pruebas = 192.168.217.16    produccion = 192.168.217.21
