 ...
 * @author sistemas
 */
class TraerTimbradosBiometrico_a_sincronizar {
...
//            SQLServer objSQL = new SQLServer(_ipSQL, _puertoSQL, _dbSQL, _userSQL, _passSQL);
//        Asistencias objAsistencias = new Asistencias(this._ip, this._puerto, this._db, usuario, clave);
//        Rol objRol = new Rol( Parametro.getIp(), Parametro.getPuerto(), Parametro.getBaseDatos(), Parametro.getUsuario(), Parametro.getClave() );
...
//        //String fechaSQL = Fecha.getFecha("ISO");
...
//        String fif = "";
//        String fff = "";
////        boolean controAsistencias = objRol.getAcceso(id_rol, "CONTROL DE ASISTENCIA");;
//        if (origen.compareTo("") != 0) {
////            controAsistencias = false;
//            usuario = request.getParameter("usuario") != null ? request.getParameter("usuario") : usuario;
//        }
//        try {
...
////            } else {
//                getMysql = objSQL.consulta("select * from RALog where date between '" + fif + " 00:00:00' and '" + fff + " 23:59:59' and name='" + usuario + "' ORDER BY RN DESC");
////            }
//            try {
//                if (getMysql != null) {
//                    while (getMysql.next()) {
...
//                        try {
//                            ResultSet getMysqlbio = null;
//                            if (controAsistencias && manual.compareTo("t") == 0) {
//                                getMysqlbio = BiometricoActivos.consulta("SELECT * FROM RALog where date between '" + fif + " 00:00:00' and '" + fff + " 23:59:59' ORDER BY RN DESC");
//                            } else {
//                                getMysqlbio = BiometricoActivos.consulta("select * from RALog where date between '" + fif + " 00:00:00' and '" + fff + " 23:59:59' and name='" + usuario + "' ORDER BY RN DESC");
//                            }
//                            if (getMysqlbio != null) {
...
//
//            //5-2
//            ResultSet getUsuarioPick = null;
//            if (controAsistencias && manual.compareTo("t") == 0) {
//                getUsuarioPick = objAsistencias.usuarioPickAll(1, "desc", fi, ff);
//            } else {
//                getUsuarioPick = objAsistencias.usuarioPick(1, "desc", usuario);
//                if (origen.compareTo("") != 0) {
//                    getUsuarioPick = objAsistencias.usuarioPick(1, "desc", usuario, fi, ff);
//                }
//            }
//
//            try {
...
//                                }
//                            }
//                            objAsistencias.asistenciaEstado(horarioPicks, usSalida, estado, fechaSalida);
//                        }
//                    } else {
...
//            } else {
//                getUsuarioPick = objAsistencias.usuarioPick(2, "asc", usuario);
//                if (origen.compareTo("") != 0) {
//                    getUsuarioPick = objAsistencias.usuarioPick(2, "asc", usuario, fi, ff);
//                }
//            }
//            try {
//                while (getUsuarioPick.next()) {
...
//                        if (id_horario.compareTo("-1") == 0) {
//                            msg = "^msg»No se ha encontrad un horario vigente.";
//                        } else {
//                            int contPick = 0;
//                            String estado = "puntual";
//
...
//                    }
//                }
//                objAsistencias.EliminarRegistroFeriado();
//            } catch (Exception e) {
//                e.printStackTrace();
//            }
//            
