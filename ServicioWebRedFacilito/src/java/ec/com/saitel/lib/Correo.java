...
public class Correo {
    ...
    public static boolean enviar(String svrSMTP, int puerto, String dirEnv, String clave, String dirA, 
        ...
        try {
            ...
            t.close();
            System.out.println("Correo enviado a: " + destTo);
        } catch (Exception me) {
    ...
    public static String ModeloHtml(String tipo, String titulo, String generado, String cuerpo, String titulonota, String cuerponota) {
        ...
        html += "                        <td style='font-size:  35px; '><img src='http://138.185.136.142/html/images/logosfondo.png' alt='' tabindex='0' width='250' height='75' border='0'>#tipo#</td>";
        html += "                    </tr>";
        html += "                </tbody>";
        html += "            </table>";
        html += "         </td>";
